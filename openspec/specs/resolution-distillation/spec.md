# Capability: resolution-distillation

## Purpose
The requirement and mechanical check that every resolution states where (or whether) its decision lands in the operational loop.
